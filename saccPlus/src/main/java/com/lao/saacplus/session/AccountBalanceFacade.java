...
public class AccountBalanceFacade {
	...
	public void saveOrUpdateChartOfAccount(List<AccountBalance> accountBalanceList,Date balanceDate,Company company,UserProfile userProfile) throws Exception{
