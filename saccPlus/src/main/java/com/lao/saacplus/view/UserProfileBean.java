...
public class UserProfileBean implements Serializable
{
	...
	private int page;
	private long count;
	private List<UserProfile> pageItems;
	...
	public String update()
	{
		...
		try
		{
			if (this.id == null)
			{
				...
				userProfile.setCreateBy(session.getUserProfile().getUserLoginName());
			...
			else
			{
				...
				userProfile.setUpdateBy(session.getUserProfile().getUserLoginName());
	...
	public List<UserProfile> getPageItems()
	{
	...
	public Converter getConverter()
	{
		...
		return new Converter()
		{
					...
					UIComponent component, Object value)
			{
				...
				return String.valueOf(((UserProfile) value).getId());
			}
		};
	}
