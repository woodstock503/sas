...
import com.lao.saacplus.session.AccountTypeFacade;
	...
	public String update()
	{
		...
		try
		{
			if (this.id == null)
			{
				...
				accountType.setCreateBy(session.getUserProfile().getUserLoginName());
			...
			else
			{
				...
				accountType.setUpdateBy(session.getUserProfile().getUserLoginName());
