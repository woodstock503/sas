...
import sas.saccplus.session.AccountBookFacade;
...
import sas.saccplus.session.CounterSingleton;
import sas.saccplus.session.DepartmentFacade;
	...
	public String save(){
		...
		try{
			...
			if(transactionMaster.getId()==null){
				...
				transactionMaster.setCreateUser(session.getUser());
